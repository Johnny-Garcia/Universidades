 ...
 *  Iso significa que nao ha necessidade de instanciar um objeto para invocar os m�todos.
 *  Sintaxe p/ chamada: <nome_da_classe>.<nome_do_metodo>(<mensagem de solicita��o>)
